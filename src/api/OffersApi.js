...
export default class OffersApi {
    ...
    */
     ...
     */
    addOfferAssignmentsWithHttpInfo(id, requestBody) {
      let postBody = requestBody;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling addOfferAssignments");
      }
      // verify the required parameter 'requestBody' is set
      if (requestBody === undefined || requestBody === null) {
        throw new Error("Missing the required parameter 'requestBody' when calling addOfferAssignments");
      }
      ...
      return this.apiClient.callApi(
        '/consume/api/v8/offers/{id}/assignments/add', 'POST',
     ...
     */
    addOfferAssignments(id, requestBody) {
      return this.addOfferAssignmentsWithHttpInfo(id, requestBody)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/CatalogAssignment>} and HTTP response
     */
    removeOfferAssignmentsWithHttpInfo(id, requestBody) {
      let postBody = requestBody;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling removeOfferAssignments");
      }
      // verify the required parameter 'requestBody' is set
      if (requestBody === undefined || requestBody === null) {
        throw new Error("Missing the required parameter 'requestBody' when calling removeOfferAssignments");
      }
      ...
      let returnType = [CatalogAssignment];
      return this.apiClient.callApi(
        '/consume/api/v8/offers/{id}/assignments/remove', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/CatalogAssignment>}
     */
    removeOfferAssignments(id, requestBody) {
      return this.removeOfferAssignmentsWithHttpInfo(id, requestBody)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
