...
export default class ProductsApi {
    ...
    */
     ...
     */
    addProductAssignmentsWithHttpInfo(id, requestBody) {
      let postBody = requestBody;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling addProductAssignments");
      }
      // verify the required parameter 'requestBody' is set
      if (requestBody === undefined || requestBody === null) {
        throw new Error("Missing the required parameter 'requestBody' when calling addProductAssignments");
      }
      ...
      return this.apiClient.callApi(
        '/consume/api/v8/products/{id}/assignments/add', 'POST',
     ...
     */
    addProductAssignments(id, requestBody) {
      return this.addProductAssignmentsWithHttpInfo(id, requestBody)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/CatalogAssignment>} and HTTP response
     */
    removeProductAssignmentsWithHttpInfo(id, requestBody) {
      let postBody = requestBody;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling removeProductAssignments");
      }
      // verify the required parameter 'requestBody' is set
      if (requestBody === undefined || requestBody === null) {
        throw new Error("Missing the required parameter 'requestBody' when calling removeProductAssignments");
      }
      ...
      let returnType = [CatalogAssignment];
      return this.apiClient.callApi(
        '/consume/api/v8/products/{id}/assignments/remove', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/CatalogAssignment>}
     */
    removeProductAssignments(id, requestBody) {
      return this.removeProductAssignmentsWithHttpInfo(id, requestBody)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
