...
export default class WorkflowsApi {
    ...
    */
     ...
     */
    importWorkflowWithHttpInfo(tenantIds, requestBody, opts) {
      opts = opts || {};
      let postBody = requestBody;
      // verify the required parameter 'tenantIds' is set
      if (tenantIds === undefined || tenantIds === null) {
        throw new Error("Missing the required parameter 'tenantIds' when calling importWorkflow");
      }
      ...
      let queryParams = {
        'tenantIds': this.apiClient.buildCollectionParam(tenantIds, 'multi'),
        'global': opts['global']
      };
      let headerParams = {
      };
     ...
     */
    importWorkflow(tenantIds, requestBody, opts) {
      return this.importWorkflowWithHttpInfo(tenantIds, requestBody, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
