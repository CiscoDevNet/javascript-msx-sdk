...
export default class TenantsApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Tenant} and HTTP response
     */
    getTenantByExternalIdWithHttpInfo(externalId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'externalId' is set
      if (externalId === undefined || externalId === null) {
        throw new Error("Missing the required parameter 'externalId' when calling getTenantByExternalId");
      }
      ...
      let returnType = Tenant;
      return this.apiClient.callApi(
        '/idm/api/v8/tenants/externalId/{externalId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Tenant}
     */
    getTenantByExternalId(externalId, opts) {
      return this.getTenantByExternalIdWithHttpInfo(externalId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
