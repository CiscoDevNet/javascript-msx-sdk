...
class OfferCreate {
    ...
    constructor(name, label, description, productId, version, displayOrder) { 
        OfferUpdate.initialize(this, name, label, description, productId, version, displayOrder);
        OfferCreate.initialize(this, name, label, description, productId, version, displayOrder);
    }
