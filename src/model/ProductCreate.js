...
class ProductCreate {
     ...
     * @implements module:model/ProductUpdate
     * @param name {String} 
     * @param label {String} 
    ...
    constructor(name, label, version, description, image, price, options, properties, configuration, isResource, hasChildren) { 
        ...
        ProductCreate.initialize(this, name, label, version, description, image, price, options, properties, configuration, isResource, hasChildren);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ProductUpdate.constructFromObject(data, obj);
...
// Implement ProductUpdate interface:
/**
 * @member {String} name
 */
