...
class DeviceCreate {
    ...
    constructor(tenantId, onboardType, name, model, type) { 
        DeviceCreateAllOf.initialize(this, tenantId);DeviceUpdate.initialize(this, onboardType, name, model, type);
        DeviceCreate.initialize(this, tenantId, onboardType, name, model, type);
    }
