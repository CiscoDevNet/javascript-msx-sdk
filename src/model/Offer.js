...
class Offer {
    ...
    constructor(name, label, description, productId, version) { 
        OfferAllOf.initialize(this);OfferCreate.initialize(this, name, label, description, productId, version);
        Offer.initialize(this, name, label, description, productId, version);
    }
