...
class UserCreate {
     ...
     */
    constructor(lastName, email, username) { 
        UserUpdate.initialize(this, lastName, email);UserCreateAllOf.initialize(this, username);
        UserCreate.initialize(this, lastName, email, username);
    }
     ...
     */
    static initialize(obj, lastName, email, username) { 
