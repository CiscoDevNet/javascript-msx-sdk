...
class UserCreate {
     ...
     */
    constructor(lastName, email, passwordPolicyName, password) { 
        UserUpdate.initialize(this, lastName, email, passwordPolicyName);UserCreateAllOf.initialize(this, password);
        UserCreate.initialize(this, lastName, email, passwordPolicyName, password);
    }
     ...
     */
    static initialize(obj, lastName, email, passwordPolicyName, password) { 
