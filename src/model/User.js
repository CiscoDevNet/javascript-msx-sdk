...
class User {
    ...
    constructor(lastName, email, passwordPolicyName, password) { 
        UserAllOf.initialize(this);UserCreate.initialize(this, lastName, email, passwordPolicyName, password);
        User.initialize(this, lastName, email, passwordPolicyName, password);
    }
