...
(function(root, factory) {
  ...
  describe('TenantsApi', function() {
    ...
    describe('getTenantByExternalId', function() {
      it('should call getTenantByExternalId successfully', function(done) {
        //uncomment below and update the code to test getTenantByExternalId
        //instance.getTenantByExternalId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
