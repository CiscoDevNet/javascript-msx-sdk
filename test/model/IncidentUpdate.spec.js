...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.IncidentUpdate();
  });
  ...
  describe('IncidentUpdate', function() {
    it('should create an instance of IncidentUpdate', function() {
      ...
      //var instane = new JavascriptMsxSdk.IncidentUpdate();
      //expect(instance).to.be.a(JavascriptMsxSdk.IncidentUpdate);
    });

    it('should have the property attributes (base name: "attributes")', function() {
      // uncomment below and update the code to test the property attributes
      //var instance = new JavascriptMsxSdk.IncidentUpdate();
