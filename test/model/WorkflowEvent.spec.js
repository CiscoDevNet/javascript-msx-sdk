...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.WorkflowEvent();
  });
  ...
  describe('WorkflowEvent', function() {
    it('should create an instance of WorkflowEvent', function() {
      // uncomment below and update the code to test WorkflowEvent
      //var instane = new JavascriptMsxSdk.WorkflowEvent();
      //expect(instance).to.be.a(JavascriptMsxSdk.WorkflowEvent);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.WorkflowEvent();
