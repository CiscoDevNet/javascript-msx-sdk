...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.BillingCyclesPage();
  });
  ...
  describe('BillingCyclesPage', function() {
    it('should create an instance of BillingCyclesPage', function() {
      // uncomment below and update the code to test BillingCyclesPage
      //var instane = new JavascriptMsxSdk.BillingCyclesPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.BillingCyclesPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.BillingCyclesPage();
