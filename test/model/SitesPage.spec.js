...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.SitesPage();
  });
  ...
  describe('SitesPage', function() {
    it('should create an instance of SitesPage', function() {
      // uncomment below and update the code to test SitesPage
      //var instane = new JavascriptMsxSdk.SitesPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.SitesPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.SitesPage();
