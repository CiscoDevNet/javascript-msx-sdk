...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.WorkflowInstanceAllOf();
  });
  ...
  describe('WorkflowInstanceAllOf', function() {
    it('should create an instance of WorkflowInstanceAllOf', function() {
      // uncomment below and update the code to test WorkflowInstanceAllOf
      //var instane = new JavascriptMsxSdk.WorkflowInstanceAllOf();
      //expect(instance).to.be.a(JavascriptMsxSdk.WorkflowInstanceAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.WorkflowInstanceAllOf();
