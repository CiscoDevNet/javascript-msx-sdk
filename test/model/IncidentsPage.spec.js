...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.IncidentsPage();
  });
  ...
  describe('IncidentsPage', function() {
    it('should create an instance of IncidentsPage', function() {
      // uncomment below and update the code to test IncidentsPage
      //var instane = new JavascriptMsxSdk.IncidentsPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.IncidentsPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.IncidentsPage();
