...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.BillingEventsPage();
  });
  ...
  describe('BillingEventsPage', function() {
    it('should create an instance of BillingEventsPage', function() {
      // uncomment below and update the code to test BillingEventsPage
      //var instane = new JavascriptMsxSdk.BillingEventsPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.BillingEventsPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.BillingEventsPage();
