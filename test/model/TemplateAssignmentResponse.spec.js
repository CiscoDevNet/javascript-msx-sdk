...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TemplateAssignmentResponse();
  });
  ...
  describe('TemplateAssignmentResponse', function() {
    it('should create an instance of TemplateAssignmentResponse', function() {
      // uncomment below and update the code to test TemplateAssignmentResponse
      //var instane = new JavascriptMsxSdk.TemplateAssignmentResponse();
      //expect(instance).to.be.a(JavascriptMsxSdk.TemplateAssignmentResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.TemplateAssignmentResponse();
