...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.BillingPriceCreate();
  });
  ...
  describe('BillingPriceCreate', function() {
    it('should create an instance of BillingPriceCreate', function() {
      // uncomment below and update the code to test BillingPriceCreate
      //var instane = new JavascriptMsxSdk.BillingPriceCreate();
      //expect(instance).to.be.a(JavascriptMsxSdk.BillingPriceCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new JavascriptMsxSdk.BillingPriceCreate();
