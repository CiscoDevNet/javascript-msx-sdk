...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TemplateAssignmentAllOf();
  });
  ...
  describe('TemplateAssignmentAllOf', function() {
    it('should create an instance of TemplateAssignmentAllOf', function() {
      // uncomment below and update the code to test TemplateAssignmentAllOf
      //var instane = new JavascriptMsxSdk.TemplateAssignmentAllOf();
      //expect(instance).to.be.a(JavascriptMsxSdk.TemplateAssignmentAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.TemplateAssignmentAllOf();
