...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.UpdatePassword();
  });
  ...
  describe('UpdatePassword', function() {
    it('should create an instance of UpdatePassword', function() {
      ...
      //var instane = new JavascriptMsxSdk.UpdatePassword();
      //expect(instance).to.be.a(JavascriptMsxSdk.UpdatePassword);
    });

    it('should have the property username (base name: "username")', function() {
      // uncomment below and update the code to test the property username
      //var instance = new JavascriptMsxSdk.UpdatePassword();
