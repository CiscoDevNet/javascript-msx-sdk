...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TemplateApplication();
  });
  ...
  describe('TemplateApplication', function() {
    it('should create an instance of TemplateApplication', function() {
      // uncomment below and update the code to test TemplateApplication
      //var instane = new JavascriptMsxSdk.TemplateApplication();
      //expect(instance).to.be.a(JavascriptMsxSdk.TemplateApplication);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.TemplateApplication();
