...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.ServiceNowConfiguration();
  });
  ...
  describe('ServiceNowConfiguration', function() {
    it('should create an instance of ServiceNowConfiguration', function() {
      ...
      //var instane = new JavascriptMsxSdk.ServiceNowConfiguration();
      //expect(instance).to.be.a(JavascriptMsxSdk.ServiceNowConfiguration);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.ServiceNowConfiguration();
