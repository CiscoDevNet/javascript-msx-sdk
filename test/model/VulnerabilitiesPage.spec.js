...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.VulnerabilitiesPage();
  });
  ...
  describe('VulnerabilitiesPage', function() {
    it('should create an instance of VulnerabilitiesPage', function() {
      // uncomment below and update the code to test VulnerabilitiesPage
      //var instane = new JavascriptMsxSdk.VulnerabilitiesPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.VulnerabilitiesPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.VulnerabilitiesPage();
