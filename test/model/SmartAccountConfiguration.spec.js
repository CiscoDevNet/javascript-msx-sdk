...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.SmartAccountConfiguration();
  });
  ...
  describe('SmartAccountConfiguration', function() {
    it('should create an instance of SmartAccountConfiguration', function() {
      // uncomment below and update the code to test SmartAccountConfiguration
      //var instane = new JavascriptMsxSdk.SmartAccountConfiguration();
      //expect(instance).to.be.a(JavascriptMsxSdk.SmartAccountConfiguration);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.SmartAccountConfiguration();
