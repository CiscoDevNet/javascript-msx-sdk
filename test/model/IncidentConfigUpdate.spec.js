...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.IncidentConfigUpdate();
  });
  ...
  describe('IncidentConfigUpdate', function() {
    it('should create an instance of IncidentConfigUpdate', function() {
      // uncomment below and update the code to test IncidentConfigUpdate
      //var instane = new JavascriptMsxSdk.IncidentConfigUpdate();
      //expect(instance).to.be.a(JavascriptMsxSdk.IncidentConfigUpdate);
    });

    it('should have the property clientId (base name: "clientId")', function() {
      // uncomment below and update the code to test the property clientId
      //var instance = new JavascriptMsxSdk.IncidentConfigUpdate();
