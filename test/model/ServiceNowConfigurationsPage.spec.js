...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.ServiceNowConfigurationsPage();
  });
  ...
  describe('ServiceNowConfigurationsPage', function() {
    it('should create an instance of ServiceNowConfigurationsPage', function() {
      // uncomment below and update the code to test ServiceNowConfigurationsPage
      //var instane = new JavascriptMsxSdk.ServiceNowConfigurationsPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.ServiceNowConfigurationsPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.ServiceNowConfigurationsPage();
