...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TenantsPage();
  });
  ...
  describe('TenantsPage', function() {
    it('should create an instance of TenantsPage', function() {
      // uncomment below and update the code to test TenantsPage
      //var instane = new JavascriptMsxSdk.TenantsPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.TenantsPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.TenantsPage();
