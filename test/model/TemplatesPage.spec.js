...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TemplatesPage();
  });
  ...
  describe('TemplatesPage', function() {
    it('should create an instance of TemplatesPage', function() {
      // uncomment below and update the code to test TemplatesPage
      //var instane = new JavascriptMsxSdk.TemplatesPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.TemplatesPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.TemplatesPage();
