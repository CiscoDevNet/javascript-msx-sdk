...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.ProductsPage();
  });
  ...
  describe('ProductsPage', function() {
    it('should create an instance of ProductsPage', function() {
      // uncomment below and update the code to test ProductsPage
      //var instane = new JavascriptMsxSdk.ProductsPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.ProductsPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.ProductsPage();
