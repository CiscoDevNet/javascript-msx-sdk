...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.GenericEvent();
  });
  ...
  describe('GenericEvent', function() {
    it('should create an instance of GenericEvent', function() {
      ...
      //var instane = new JavascriptMsxSdk.GenericEvent();
      //expect(instance).to.be.a(JavascriptMsxSdk.GenericEvent);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new JavascriptMsxSdk.GenericEvent();
