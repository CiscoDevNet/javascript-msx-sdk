...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.BillingCycleUpdate();
  });
  ...
  describe('BillingCycleUpdate', function() {
    it('should create an instance of BillingCycleUpdate', function() {
      // uncomment below and update the code to test BillingCycleUpdate
      //var instane = new JavascriptMsxSdk.BillingCycleUpdate();
      //expect(instance).to.be.a(JavascriptMsxSdk.BillingCycleUpdate);
    });
    ...
    it('should have the property eventId (base name: "eventId")', function() {
      ...
      //var instance = new JavascriptMsxSdk.BillingCycleUpdate();
