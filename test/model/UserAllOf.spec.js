...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.UserAllOf();
  });
  ...
  describe('UserAllOf', function() {
    it('should create an instance of UserAllOf', function() {
      ...
      //var instane = new JavascriptMsxSdk.UserAllOf();
      //expect(instance).to.be.a(JavascriptMsxSdk.UserAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new JavascriptMsxSdk.UserAllOf();
