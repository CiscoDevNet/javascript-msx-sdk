...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.DeviceCreate();
  });
  ...
  describe('DeviceCreate', function() {
    it('should create an instance of DeviceCreate', function() {
      ...
      //var instane = new JavascriptMsxSdk.DeviceCreate();
      //expect(instance).to.be.a(JavascriptMsxSdk.DeviceCreate);
    });
    ...
    it('should have the property serviceInstanceId (base name: "serviceInstanceId")', function() {
      ...
      //var instance = new JavascriptMsxSdk.DeviceCreate();
