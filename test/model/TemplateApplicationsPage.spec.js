...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TemplateApplicationsPage();
  });
  ...
  describe('TemplateApplicationsPage', function() {
    it('should create an instance of TemplateApplicationsPage', function() {
      // uncomment below and update the code to test TemplateApplicationsPage
      //var instane = new JavascriptMsxSdk.TemplateApplicationsPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.TemplateApplicationsPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.TemplateApplicationsPage();
