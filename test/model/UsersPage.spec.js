...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.UsersPage();
  });
  ...
  describe('UsersPage', function() {
    it('should create an instance of UsersPage', function() {
      // uncomment below and update the code to test UsersPage
      //var instane = new JavascriptMsxSdk.UsersPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.UsersPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.UsersPage();
