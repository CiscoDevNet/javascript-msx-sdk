...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.DevicesPage();
  });
  ...
  describe('DevicesPage', function() {
    it('should create an instance of DevicesPage', function() {
      // uncomment below and update the code to test DevicesPage
      //var instane = new JavascriptMsxSdk.DevicesPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.DevicesPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.DevicesPage();
