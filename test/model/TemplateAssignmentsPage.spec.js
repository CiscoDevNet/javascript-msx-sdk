...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TemplateAssignmentsPage();
  });
  ...
  describe('TemplateAssignmentsPage', function() {
    it('should create an instance of TemplateAssignmentsPage', function() {
      // uncomment below and update the code to test TemplateAssignmentsPage
      //var instane = new JavascriptMsxSdk.TemplateAssignmentsPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.TemplateAssignmentsPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.TemplateAssignmentsPage();
