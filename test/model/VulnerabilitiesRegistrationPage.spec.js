...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.VulnerabilitiesRegistrationPage();
  });
  ...
  describe('VulnerabilitiesRegistrationPage', function() {
    it('should create an instance of VulnerabilitiesRegistrationPage', function() {
      // uncomment below and update the code to test VulnerabilitiesRegistrationPage
      //var instane = new JavascriptMsxSdk.VulnerabilitiesRegistrationPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.VulnerabilitiesRegistrationPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.VulnerabilitiesRegistrationPage();
