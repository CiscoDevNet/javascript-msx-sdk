...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.TemplateCreate();
  });
  ...
  describe('TemplateCreate', function() {
    it('should create an instance of TemplateCreate', function() {
      // uncomment below and update the code to test TemplateCreate
      //var instane = new JavascriptMsxSdk.TemplateCreate();
      //expect(instance).to.be.a(JavascriptMsxSdk.TemplateCreate);
    });

    it('should have the property externalId (base name: "externalId")', function() {
      // uncomment below and update the code to test the property externalId
      //var instance = new JavascriptMsxSdk.TemplateCreate();
