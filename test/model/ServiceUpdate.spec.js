...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.ServiceUpdate();
  });
  ...
  describe('ServiceUpdate', function() {
    it('should create an instance of ServiceUpdate', function() {
      ...
      //var instane = new JavascriptMsxSdk.ServiceUpdate();
      //expect(instance).to.be.a(JavascriptMsxSdk.ServiceUpdate);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new JavascriptMsxSdk.ServiceUpdate();
