...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.OffersPage();
  });
  ...
  describe('OffersPage', function() {
    it('should create an instance of OffersPage', function() {
      // uncomment below and update the code to test OffersPage
      //var instane = new JavascriptMsxSdk.OffersPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.OffersPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.OffersPage();
