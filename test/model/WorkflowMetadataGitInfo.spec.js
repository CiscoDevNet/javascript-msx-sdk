...
(function(root, factory) {
  ...
  describe('WorkflowMetadataGitInfo', function() {
    ...
    it('should have the property comittedBy (base name: "comitted_by")', function() {
      // uncomment below and update the code to test the property comittedBy
      //var instance = new JavascriptMsxSdk.WorkflowMetadataGitInfo();
      //expect(instance).to.be();
    });

    it('should have the property comittedOn (base name: "comitted_on")', function() {
      // uncomment below and update the code to test the property comittedOn
      //var instance = new JavascriptMsxSdk.WorkflowMetadataGitInfo();
      //expect(instance).to.be();
    });
