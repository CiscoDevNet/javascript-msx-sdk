...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.BillingPricesPage();
  });
  ...
  describe('BillingPricesPage', function() {
    it('should create an instance of BillingPricesPage', function() {
      // uncomment below and update the code to test BillingPricesPage
      //var instane = new JavascriptMsxSdk.BillingPricesPage();
      //expect(instance).to.be.a(JavascriptMsxSdk.BillingPricesPage);
    });

    it('should have the property page (base name: "page")', function() {
      // uncomment below and update the code to test the property page
      //var instance = new JavascriptMsxSdk.BillingPricesPage();
