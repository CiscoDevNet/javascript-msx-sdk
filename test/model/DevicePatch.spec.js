...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptMsxSdk.DevicePatch();
  });
  ...
  describe('DevicePatch', function() {
    it('should create an instance of DevicePatch', function() {
      ...
      //var instane = new JavascriptMsxSdk.DevicePatch();
      //expect(instance).to.be.a(JavascriptMsxSdk.DevicePatch);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new JavascriptMsxSdk.DevicePatch();
